...
namespace EMX.JobyJobs.ASPCoreFwk.API.Helpers
{
  ...
  /// <summary>
  ///service models - business objects
  /// </summary>
  public class AutoMapperProfile4 : Profile
  {
    ...
    {
      //Add as many of these lines as you need to map your objects
      CreateMap<RegisterSeekerServiceRequest, Seeker>();
      CreateMap<RegisterEmployerServiceRequest, EmployerPerson>();
      CreateMap<RegisterEmployerPersonServiceRequest, EmployerPerson>();
      CreateMap<PostPositionServiceRequest, Position>();
      CreateMap<SetInterviewServiceRequest, Interview>();
      CreateMap<UpdateSeekerServiceRequest, Seeker>();
      CreateMap<UpdateEmployerServiceRequest, Employer>();
      CreateMap<UpdateEmployerPersonServiceRequest, EmployerPerson>();
      CreateMap<SendMessageEmployerToSeekerServiceRequest, ChatMessage>();
      CreateMap<SendMessageSeekerToEmployerServiceRequest, ChatMessage>();
    }

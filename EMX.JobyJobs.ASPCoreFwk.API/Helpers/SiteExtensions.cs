...
namespace EMX.JobyJobs.ASPCoreFwk.API.Helpers
{
  ...
  public static class SiteExtensions
  {
    ...
    /// <summary>
    /// Returns the identifier for the current action.
    /// </summary>
    /// <param name="controller"></param>
    /// <returns></returns>
    public static int GetIdentityIdentifier(this Controller controller)
    {
      return controller.User.Identity.Name.IntTryParse(0);
    }

    /// <summary>
    /// Returns the seekerId for the current action.
    /// </summary>
    /// <param name="controller"></param>
    /// <returns></returns>
    public static int GetIdentitySeekerId(this Controller controller)
    {
      return controller.User.Identity.Name.IntTryParse(0);
    }
    /// <summary>
    /// Returns the employerPersonId for the current action.
    /// </summary>
    /// <param name="controller"></param>
    /// <returns></returns>
    public static int GetIdentityEmployerPersonId(this Controller controller)
    {
      return controller.User.Identity.Name.IntTryParse(0);
    }
    /// <summary>
    /// Returns the employerId for the current action.
    /// </summary>
    /// <param name="controller"></param>
    /// <returns></returns>
    public static int GetIdentityEmployerId(this Controller controller)
    {
      return controller.User.FindFirst(ClaimTypes.GroupSid)?.Value.IntTryParse(0) ?? 0;
    }

    /// <summary>
    /// Returns the languageCode for the current action.
    /// </summary>
    /// <param name="controller"></param>
    /// <returns></returns>
    public static string GetIdentityLanguageCode(this Controller controller)
    {
      return controller.User.FindFirst(ClaimTypes.Locality)?.Value;
    }
  }
}
